...
type AuthClient interface {
	Register(ctx context.Context, in *ReqisterRequest, opts ...grpc.CallOption) (*ReqisterResponse, error)
...
func (c *authClient) Register(ctx context.Context, in *ReqisterRequest, opts ...grpc.CallOption) (*ReqisterResponse, error) {
	out := new(ReqisterResponse)
...
type AuthServer interface {
	Register(context.Context, *ReqisterRequest) (*ReqisterResponse, error)
...
func (UnimplementedAuthServer) Register(context.Context, *ReqisterRequest) (*ReqisterResponse, error) {
